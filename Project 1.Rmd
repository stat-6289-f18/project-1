    ...
    mainPanel(
      ...
      tabsetPanel(type = "tabs", 
                 ...
                 tabPanel("Team Overview",
                          br(),
                          h5("The plot below shows the selected team result over the selected period of time."),
                          plotOutput("teamplot"), 
                          br(), 
                          h5("The descriptive statistics below shows the selected team result over the selected period of time."),
                 verbatimTextOutput("teamsummary"),
                 br(),
                 h5("The table below shows the data pf the selected team result over the selected period of time."),
...
server <- function(input, output) {
  ...
  # Print team data table
    output$teamstable <- DT::renderDataTable(
      DT::datatable(data = team_selected(), 
                    options = list(pageLength = input$obs),
                    rownames = FALSE)
    )  
